...
<article>
  <section class="flex">
    <WorkHeader background="#d2dae5" image="img/betsense-mock.png">
      ...
      <ul slot="labels" class="text-gray-900" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="1400">
